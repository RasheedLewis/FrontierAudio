...
class SpeakerVerificationHarnessTest {
    ...
    fun sameSpeakerSamplesScoreWithHighConfidence() {
        ...
        assertTrue(
                ...
                "Expected confidence ≥ 0.6 but was ${result.confidence}"
        )
    }
    ...
    fun differentSpeakersProduceLowConfidence() {
        ...
        assertTrue(
                ...
                "Expected low confidence but was ${result.confidence}"
        )
    }
    ...
    fun gainNormalizationBringsRmsIntoTargetBand() {
        ...
        assertTrue(
                quietAnalysis.processedRms > quietAnalysis.rawRms,
                "Quiet clip should gain volume"
        )
        assertTrue(
                loudAnalysis.processedRms < loudAnalysis.rawRms,
                "Loud clip should be attenuated"
        )
        assertTrue(
